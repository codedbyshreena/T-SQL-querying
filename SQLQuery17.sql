...
CREATE VIEW SUP_HIGH_SALARY_EMP
AS 
SELECT *
FROM EMPLOYEE
WHERE SALARY > 14000
...
CREATE OR ALTER VIEW EMPLOYEES_START_R
AS 
SELECT *
FROM EMPLOYEE
...
CREATE OR ALTER VIEW EMPLOYEES_NAMECONTAINS_H
AS 
SELECT *
FROM EMPLOYEE
...
CREATE VIEW EMPLOYEE_NAME_START
AS 
SELECT EID, FIRSTNAME, DEPARTMENT
FROM EMPLOYEE
