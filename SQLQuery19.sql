...
--24. Display customers who are offline customers but not from RAJKOT city using MINUS(EXCEPT).
SELECT Name FROM OFFLINE_CUSTOMER
EXCEPT
SELECT Name FROM CUSTOMER
WHERE CITY = 'RAJKOT'

--25. Display customers who are GOLD members, online customers, and from SURAT city 
--INTERSECT. 
SELECT Name FROM CUSTOMER
WHERE MEMBERSHIP = 'GOLD'
INTERSECT
