...
SELECT TOP 3 STDID, SNAME, BRANCH
FROM STUDENT
WHERE BRANCH <> 'COMPUTER'
...
SELECT STDID, SNAME, CITY, BRANCH FROM STUDENT
WHERE SPI > 8.5

--25. Retrieve names of students whose city is ‘RAJKOT’ and SPI is less than 8.00.
SELECT SNAME, SPI, CITY FROM STUDENT
...
--104 and 108. 
SELECT * FROM STUDENT 
WHERE SPI > 7.5 AND SPI < 9.0 AND NOT STDID IN (104, 108)
...
SELECT SNAME, STDID, CITY, SPI FROM STUDENT
